...
const Post = () => {
  ...
  <CardHeader
    avatar={
      <Avatar sx={{ bgcolor:"#1565c0"  }} aria-label="recipe">
        M
      </Avatar>
    }
    action={
...
<button className="discord-button button" style={{transitionDelay: '0s, 0s, 0s', transitionproperty:' translate background boxShadow'}}>
...
<button className="twitter-button button" style={{transitionDelay:' 0.1s, 0s, 0.1s', transitionProperty: 'translate background boxShadow'}}>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="30" width="30">
...
<button className="reddit-button button" style={{transitionDelay: '0.2s, 0s, 0.2s', transitionProperty:' translate background boxShadow'}}>
  <svg width="30" height="30" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<button className="messenger-button button" style={{transitionDelay: '0.3s, 0s, 0.3s', transitionProperty: 'translate background boxShadow'}}>
  <svg width="30" height="30" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<button className="pinterest-button button" style={{transitionDelay: '0.4s, 0s, 0.4s', transitionProperty: 'translate background boxShadow'}}>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="30" width="30">
...
<button className="instagram-button button" style={{transitionDelay: '0.5s, 0s, 0.5s', transitionProperty: 'translate background boxShadow'}}>
  <svg width="30" height="30" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<button className="snapchat-button button" style={{transitionDelay:' 0.6s, 0s, 0.6s', transitionProperty:' translate background boxShadow' }}>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="30" width="30">
...
<button className="whatsapp-button button" style={{transitionDelay: '0.7s, 0s, 0.7s',transitionProperty: 'translate background boxShadow'}}>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" height="30" width="30">
